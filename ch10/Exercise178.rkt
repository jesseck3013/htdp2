...
; Both (string-length "\t") and (string-length "\r") are 1.
; For this reason, \t and \r are special cases of strings of length 1. Special cases should be above the general case.
