...
; This implementation also uses the accumulator's idea. In addition to the accumulator, this implementation also introduces reverse twice. It actually slows down the performance compared to the original one.
