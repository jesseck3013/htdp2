...
; divisors uses k controls the recursion, which means the function check numbers between [1, k].

; Because S is the smaller number between S and K. Any number that is larger than S is impossible to be the GCD between S and K.
