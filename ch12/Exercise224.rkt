...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise224) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp") (lib "dir.rkt" "teachpack" "htdp")) #f)))
    ...
    [else
     (or 
      (and 
       (< 
        (abs (- (posn-x u)
                (posn-x (first m)))) (/ UFO-WIDTH 2))
       (< 
        (abs (- (posn-y u)
                (posn-y (first m)))) (/ UFO-HEIGHT 2)))
      (missile-hit? u (rest m)))]))
