...
; They both output #true if either the first expression or the second expression is true.

; I prefer the version in this exercise, because it is more efficient. It doesn't process the entire list every time.
