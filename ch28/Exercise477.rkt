...
; 1. '() is the trivial problem
; 2. the solution to the trivial problem is '() because no arrangement needed.
; 3. sub-problem: insert a 1string into the front of all arrangements without the 1string.
; 4. use append to combine all the solutions to the sub-problems
