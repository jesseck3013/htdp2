...
; FT -> Boolean
; Does any of ancestors of the given child has blue eyes
...
; This function fails because it always return #false.
; To fix the issue, I replaced the recusive call blue-eyed-ancestor? with blue-eyed-child?
