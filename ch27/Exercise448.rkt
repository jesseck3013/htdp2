...
; If a function f is continuous, and there exists an interval
; [a, b] where (< (f a) 0 (f b)) or (< (f b) 0 (f a)), the function can definitely terminate. Because every recursive call make the interval smaller, eventually it will be smaller than ε.
