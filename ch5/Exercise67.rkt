...
; The ball moves 3 pixels every clock tick
(define SPEED 3)

; balld
; Interpretation location:  the distance between the ball and the top of the room
; Interpretation direction: moving up or down
